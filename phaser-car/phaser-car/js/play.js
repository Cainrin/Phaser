...
States.play = function () {
    ...
    this.onStart = function () {
        ...
        this.obsTeam = new Obstacles(5, 'img_23', 1, 400, this.updateScoreHp, this);
    ...
    this.showFinalText = function() {
        ...
        this.gameOverImg = new Puzzle.Image(this, 0, -(this.startWarning.height / 2 - this.startWarning.height / 10),
            'img_24', null, null);
        this.gameNoImg = new Puzzle.Image(this, -100, -(this.startWarning.height / 2 - this.startWarning.height / 4),
            'img_25', null, null);
        ...
        this.againBtn = new Puzzle.Button(this, -125, this.startWarning.height / 4, 'btn_6', function() {
            game.state.start('play');
        }, this);
        this.backMenu = new Puzzle.Button(this, 125, this.startWarning.height / 4, 'btn_8', function() {
            game.state.start('menu');
        }, this);
        this.rankMenu = new Puzzle.Button(this, -120, this.startWarning.height / 2.5, 'btn_2', function() {
            alert("滚！");
        }, this);
        this.inviteFri = new Puzzle.Button(this, 120, this.startWarning.height / 2.5, 'btn_13', function() {
            alert("滚！");
        }, this);
